...
def get_tomodrgn_path():
    ...
    command_base = f"source activate {tomodrgn_path}; {tomodrgn_path}/tomodrgn"
    return command_base
...
def tomodrgn_train(parameters, input_dir, name, output):
    ...
    training_parameters = f"-n {parameters['heterogeneity_tomodrgn_train_epochs']} \
        ...
        --pe-type {parameters['heterogeneity_tomodrgn_dec_type']} \
    ...
    command = f"{get_tomodrgn_path()} train_vae {particles_input} --datadir {input_dir} --zdim {parameters['heterogeneity_tomodrgn_train_zdim']} --num-epochs {parameters['heterogeneity_tomodrgn_train_epochs']} -o {output} {options} {training_parameters} {tomo} {workers}"
