...
def get_cryodrgn_path():
    ...
    command_base = f"export LD_LIBRARY_PATH={cryodrgn_path}/lib:$LD_LIBRARY_PATH; export PYTHONPATH={cryodrgn_path}/lib/python3.9/site-packages:$PYTHONPATH; export PATH={cryodrgn_path}/bin:$PATH; cryodrgn"
    return command_base
