...
.. nextpyp:: Calculating Segmentations
  ...
  * **First block (unfiltered):**
    ...
    * On the **Tomogram segmentation** tab:
      ...
      - Set the ``Pre-trained model (*.ckpt)`` to the location of ``v10_alpha`` downloaded from `membrain-seg <https://github.com/teamtomo/membrain-seg>`_ GitHub page.
